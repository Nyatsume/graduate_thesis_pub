...
この事象は，ルートリフレクタが保持するコネクション数の多寡が影響していることが考えられる．IPv4サービス提供サーバ1台がコネクション確立に掛かる時間$t_c$及び，IPv4サービス提供サーバ1台がBGP UPDATEメッセージをルートリフレクタに伝達するまでに掛かる時間$t_u$が，ルートリフレクタが保有しているBGPコネクションの多寡によって，増加していると思われる．
