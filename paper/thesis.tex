...
pdftitle={ShadowLB: A Transparently Accelerated Load Balancer},%
]{hyperref}
\usepackage{bookmark}
...
% タイトル
\def\title{ShadowLB: A Transparently Accelerated Load Balancer}
% 英語タイトル
\def\etitle{ShadowLB: A Transparently Accelerated Load Balancer}
% 著者(日本語)
\def\author{橘 直雪}
% 著者(英語)
\def\eauthor{Naoyuki Tachibana}
% 学部・研究科
...
\input{src/2_related}
\input{src/3_issue}
% \input{src/4_consideration}
\input{src/4_proposal.tex}
\input{src/5_implementation.tex}
\input{src/6_evaluation.tex}
\input{src/7_related-shadow.tex}
